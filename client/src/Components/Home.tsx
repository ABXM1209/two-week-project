...
export default function Home() {
    ...
    return <>
        ...
        <h1 style={{ textAlign: "center", fontSize: "20", fontWeight: "bold", padding: "20px" }}>
        ...
        <div className="dock">
            ...
            <button onClick={() => navigate('authors')}>
                ...
                <span className="dock-label size-6">Authors</span>
            </button>
            ...
            <button onClick={() => navigate('genres')}>
                ...
                <span className="dock-label size-6">Genres</span>
            </button>
        </div>
    </>
}